...
export default function WelcomePage() {
  const { scrollY } = useScroll();//scrollY is the umber of pixels the user scrolls 
  //we have opacity 1 at 0 when we havenot scrolled and opacity 0.5 at 200 when we have scrolled 200px
